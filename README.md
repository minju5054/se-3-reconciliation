...
The [GP-SE2-01 environment-constrained handoff pilot](docs/GP_SE2_01_ENVIRONMENT_CONSTRAINED_HANDOFF.md) now has a validated static Hospital oracle and tested rigid/GP comparison implementation. Its frozen-source offline primary comparison is pending; this implementation stage is not evidence of improved transitions.
