#!/usr/bin/env python3
"""Strictly validate and print a saved EXP-02 run."""
...
from reconciliation.exp02 import validate_exp02_output
...
def main() -> None:
    ...
    validation = validate_exp02_output(args.run_directory)
