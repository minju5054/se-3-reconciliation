#!/usr/bin/env python3
"""Frozen G4 references through unchanged official MPC; no GP optimization."""
...
import numpy as np
from reconciliation.gp_se2_diag08_endpoint_margin import execute_reference,validate_execution_records,execution_admission
...
def main():
    ...
    for name in ['execution_freeze.json','execution_request_freeze.json']:
